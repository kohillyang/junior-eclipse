...
/**
  ...
  * @retval    none
  */
static void pid_reset(k_pid_t* pid, float kp, float ki, float kd)
{
    pid->p = kp;
    pid->i = ki;
    pid->d = kd;
...
/**
  ...
  */
float pid_calc(k_pid_t* pid, float get, float set)
{
	pid->get[NOW] = get;
	pid->set[NOW] = set;
	pid->err[NOW] = set - get; 
...
k_pid_t pid_pit           = { 0 };
k_pid_t pid_yaw           = { 0 };
k_pid_t pid_yaw_speed     = { 0 }; //yaw palstance loop
k_pid_t pid_pit_speed     = { 0 }; //pitch palstance loop
k_pid_t pid_spd[4]        = { 0 };
k_pid_t pid_chassis_angle = { 0 };
k_pid_t pid_trigger          = { 0 };
k_pid_t pid_trigger_speed      = { 0 };
k_pid_t pid_imu_tmp;
